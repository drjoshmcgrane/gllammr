...
reachable through the unified `gllamm()` interface: joint mixed-type
outcomes, frailty survival, rank-ordered choices, nonparametric latent
distributions, adaptive quadrature, and cluster-robust standard errors.
...
`vignette("weights")` for a full treatment.

## References

- Aitkin, M. (1999). A general maximum likelihood analysis of
  variance components in generalized linear models. *Biometrics*, 55,
  117–128.
